...
async def lifespan(app: FastAPI):
    # from app.src.models import ModelUser, ModelProject, ModelMessage, ModelComment
    # 👉 startup
...
app.include_router(api_create_order.router, prefix="/api_v1/api_create_order",tags=["订单页面"])
app.include_router(api_get_order.router, prefix="/api_v1/get_order",tags=["小程序首页"])

app.include_router(api_user_login.router,prefix="/api_v1/get_order",tags=["用户相关"])